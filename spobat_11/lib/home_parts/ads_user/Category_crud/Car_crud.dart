...
class CarCrud extends StatefulWidget {
  const CarCrud({super.key});

  @override
  State<CarCrud> createState() => _CarCrudState();
}

class _CarCrudState extends State<CarCrud> {
  ...
  var model_ctrl=TextEditingController();
  var year_ctrl=TextEditingController();
  var km_ctrl=TextEditingController();
  var type_ctrl=TextEditingController();
  ...
  @override
  void initState() {
    _userCollection= FirebaseFirestore.instance.collection('Car');
  }
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Sell Car',style: GoogleFonts.rubik(color: Colors.blue),),
        centerTitle: true,
      ),
            ...
            child: ListView(
              ...
              children:[
                ...
                children: [
                  ...
                  Text('Model'),
                  TextField(
                    controller: model_ctrl,
                    decoration: InputDecoration(
                      hintText: 'Which model?',
                        border: OutlineInputBorder(
                            borderRadius: BorderRadius.circular(10)
                        )
                    ),
  ...
  Future<String> uploadFile(XFile _image) async{
    Reference reference=storage.ref().child('Car').child(_image.name);
