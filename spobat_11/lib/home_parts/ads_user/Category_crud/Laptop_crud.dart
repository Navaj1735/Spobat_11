...
class LaptopCrud extends StatefulWidget {
  const LaptopCrud({super.key});

  @override
  State<LaptopCrud> createState() => _LaptopCrudState();
}

class _LaptopCrudState extends State<LaptopCrud> {
  ...
  @override
  void initState() {
    _userCollection = FirebaseFirestore.instance.collection('Laptop');
  }
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Sell Laptop',style: GoogleFonts.rubik(color: Colors.blue),),
        centerTitle: true,
      ),
  ...
  Future<String> uploadFile(XFile _image) async{
    Reference reference=storage.ref().child('Laptop').child(_image.name);
