...
void main() async{
  ...
  runApp(MaterialApp(
      home: My_ads_property()));
}
class My_ads_property extends StatefulWidget {

  @override
  State<My_ads_property> createState() => _My_adsState();
}

class _My_adsState extends State<My_ads_property> {
