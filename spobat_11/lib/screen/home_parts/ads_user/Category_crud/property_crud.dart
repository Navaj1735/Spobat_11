...
class PropertyCrud extends StatefulWidget {
  const PropertyCrud({super.key});

  @override
  State<PropertyCrud> createState() => _PropertyCrudState();
}

class _PropertyCrudState extends State<PropertyCrud> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Sell Property',style: GoogleFonts.rubik(color: Colors.blue),),
        centerTitle: true,
      ),
  ...
  Future<String> uploadFile(XFile _image) async {
    Reference reference = storage.ref().child('Property').child(_image.name);
